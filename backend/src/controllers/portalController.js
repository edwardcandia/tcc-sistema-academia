...
const definirSenhaAluno = async (req, res) => {
    ...
    try {
        ...
        const result = await db.query('UPDATE alunos SET senha_hash = $1 WHERE email = $2 RETURNING id, nome_completo, email', [senhaHash, email]);
...
module.exports = { definirSenhaAluno, loginAluno, getMeusDados, getMeuHistoricoPagamentos };