...
import {
  CssBaseline, Container, Typography, Box, Button, Grid, Card, CardContent, Divider,
  Paper, List, ListItem, ListItemText, ListItemIcon, Skeleton, CircularProgress
} from '@mui/material';
import { 
  Person, CalendarToday, Paid, FitnessCenter, Notifications,
  TrendingUp, Info, ArrowForward, DirectionsRun
        ...
        <>
            ...
            <Container maxWidth="lg">
                <Box sx={{ my: 4 }}>
                    ...
                    <Grid container spacing={3} sx={{ mb: 4 }}>
                                ...
                                <CardContent sx={{ pt: 0, pb: 1 }}>
                                    <Typography variant="body2" color="text.secondary">
                                        {loading ? <Skeleton width="60%" /> : (
                                            `${estatisticas.totalAlunos ? Math.round((estatisticas.alunosAtivos / estatisticas.totalAlunos) * 100) : 0}% dos alunos`
                                        )}
                                    </Typography>
                                </CardContent>
                            </Card>
                        ...
                        <Grid item xs={12} sm={6} md={3}>
                            <Card sx={{ bgcolor: '#ffebee', color: '#c62828', height: '100%' }}>
                                {renderCardContent('Pagamentos Pendentes', estatisticas.pagamentosPendentes, loading)}
                                <CardContent sx={{ pt: 0, pb: 1 }}>
                                    <Button 
                                        component={Link} 
                                        to="/relatorios" 
                    ...
                    <Box sx={{ mt: 4 }}>
                        <Typography variant="h5" gutterBottom>Acesso Rápido</Typography>
                            ...
                            <Paper sx={{ p: 2, height: '100%' }}>
                                ...
                                {loading ? (
                                    <Box sx={{ p: 2 }}>
                                        ...
                                        <Typography variant="body2" component="span">Carregando...</Typography>
                                    </Box>
